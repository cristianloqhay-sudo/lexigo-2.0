...
export const Logo: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
    {/* Background Circle */}
    <circle cx="50" cy="50" r="48" fill="#8B5CF6" stroke="#374151" strokeWidth="2" />
    {/* LG Text Background */}
    <text x="50" y="75" fontFamily="'Merriweather', serif" fontWeight="900" fontSize="70" textAnchor="middle" fill="#000000">LG</text>
    {/* Text Bar */}
    <rect x="15" y="42" width="70" height="16" rx="4" fill="#8B5CF6" />
    {/* LEXIGO Text */}
    <text x="50" y="54" fontFamily="'Inter', sans-serif" fontWeight="800" fontSize="12" textAnchor="middle" fill="#000000" letterSpacing="2">LEXIGO</text>
  </svg>
);
